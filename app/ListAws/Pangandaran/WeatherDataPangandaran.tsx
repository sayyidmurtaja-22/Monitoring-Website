  ...
  return (
    <div style={{ padding: "24px 32px", borderBottom: "3px solid #1d3557", marginBottom: 16, backgroundColor: "#ffffff" }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, color: "#1d3557", marginBottom: 4, fontFamily: "sans-serif" }}>
        Laporan Data Cuaca — AWS Pangandaran
      </h1>
    ...
    <div className="flex flex-col gap-4 w-full">
      <div ref={exportRef} className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-4 w-full">
          <WeatherLine
            data={avgData}
            lines={TEMPERATURE_CONFIG.lines}
            title={TEMPERATURE_CONFIG.title}
            yLabel={TEMPERATURE_CONFIG.yLabel}
          />
          <StatCards
            avgData={avgData}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-4 w-full">
          <WeatherLine
            data={avgData}
            lines={WIND_DIRECTION_CONFIG.lines}
            title={WIND_DIRECTION_CONFIG.title}
            yLabel={WIND_DIRECTION_CONFIG.yLabel}
          />
          <StatCards
            avgData={avgData}
